...
vim.o.ignorecase = true; vim.o.smartcase = true -- Case-insensitive searching UNLESS \C or capital in search
vim.o.timeout = true; vim.wo.signcolumn = 'yes' -- Keep signcolumn on by default
vim.o.updatetime = 250; vim.o.timeoutlen = 0    -- Decrease update time
vim.o.completeopt = 'menuone,noselect'          -- Set completeopt to have a better completion experience
vim.o.termguicolors = true                      -- better terminal colors
