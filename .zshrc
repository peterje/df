...
# Bun
export BUN_INSTALL="/Users/peteredm/.bun"
export PATH="$BUN_INSTALL/bin:$PATH"

# pnpm
export PNPM_HOME="/Users/peteredm/Library/pnpm"
export PATH="$PNPM_HOME:$PATH"
# pnpm end

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/Users/peteredm/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/peteredm/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/peteredm/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/peteredm/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
